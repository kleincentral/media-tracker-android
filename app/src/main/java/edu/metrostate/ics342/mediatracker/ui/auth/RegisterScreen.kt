...
fun RegisterScreen(
    ...
    Column(
        ...
        Image(
            painterResource(id = edu.metrostate.ics342.mediatracker.R.drawable.ic_smart_display),
        ...
        TextButton(onClick = onNavigateToLogin) {
            Text(stringResource(edu.metrostate.ics342.mediatracker.R.string.sign_in_prompt))
        }
